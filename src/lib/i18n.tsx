...
export const TR: Record<Lang, TranslationDict> = {
  en: {
    ...
    upl_title: "Drop files to upload", upl_sub: "PDF, JPG, PNG, CSV · up to 100 MB each",
  ...
  de: {
    ...
    upl_title: "Dateien hier ablegen", upl_sub: "PDF, JPG, PNG, CSV · bis zu 100 MB je Datei",
  ...
  es: {
    ...
    upl_title: "Arrastra archivos para subir", upl_sub: "PDF, JPG, PNG, CSV · hasta 100 MB cada uno",
